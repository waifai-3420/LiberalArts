...
class Vehicle:
    ...
    def draw(self, screen, offset_x=0, offset_y=0):
        ...
        if self.rendered_image:
            ...
            # 画像がない場合のフォールバック
            pygame.draw.rect(screen, YELLOW, (draw_x - VEHICLE_SIZE // 2, draw_y - VEHICLE_SIZE // 2, VEHICLE_SIZE, VEHICLE_SIZE))
...
class Game:
    ...
    def draw_ui(self):
        ...
        if self.game_state == 'PLANNING':
            ...
            results_text = self.font.render("Delivery complete! Score: (to be implemented)", True, GREEN)
